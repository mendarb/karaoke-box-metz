...
export const FeatureGrid = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-0">
      <div className="bg-[#7E3AED] p-6 md:p-8 text-center text-white flex flex-col justify-center rounded-lg md:rounded-none">
      ...
      <div className="bg-[#F5F3FF] p-6 md:p-8 text-center flex flex-col justify-center rounded-lg md:rounded-none">
