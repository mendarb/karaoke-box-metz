  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3">
      <div className="bg-[#7E3AED] p-6 md:p-8 text-center text-white flex flex-col justify-center">
        ...
        <h3 className="text-lg md:text-xl font-semibold text-white mb-3">Salle privative</h3>
      ...
      <div className="bg-[#F5F3FF] p-6 md:p-8 text-center flex flex-col justify-center">
        <Music2 className="w-10 h-10 md:w-12 md:h-12 mx-auto text-kbox-coral mb-4" />
        <h3 className="text-lg md:text-xl font-semibold text-kbox-coral mb-3">Large choix</h3>
        <p className="text-sm md:text-base text-gray-600">Des milliers de chansons disponibles</p>
      </div>
      <div className="bg-[#7E3AED] p-6 md:p-8 text-center text-white flex flex-col justify-center">
        <Calendar className="w-10 h-10 md:w-12 md:h-12 mx-auto mb-4" />
        <h3 className="text-lg md:text-xl font-semibold text-white mb-3">Horaires flexibles</h3>
