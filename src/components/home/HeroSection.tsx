...
export const HeroSection = () => {
  ...
  <div class="w-full grid grid-cols-3 gap-4 items-center">
    ...
    <img
      ...
      alt="PayPal"
      class="w-16 h-10 object-contain opacity-80 hover:opacity-100  transition-opacity duration-300"
    />
    <img
      src="/lovable-uploads/klarna.svg"
      alt="Klarna"
      class="w-16 h-16 object-contain opacity-80 hover:opacity-100 filter invert transition-opacity duration-300"
    />
    <img
