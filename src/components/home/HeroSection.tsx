...
export const HeroSection = () => {
  return (
    <div className="bg-white/10 p-6 md:p-8 flex flex-col justify-center min-h-[200px] md:min-h-[500px]">
      <h1 className="text-2xl md:text-3xl font-bold text-white mb-4 animate-fade-in will-change-transform">
        Votre Box Karaoké Privatif à Metz
      </h1>
      <p className="text-white/90 text-sm md:text-base mb-6 animate-fade-in [--animate-delay:200ms] will-change-transform">
        Partagez des moments uniques avec vos proches dans notre espace privatif et confortable.
      </p>
      <div className="flex flex-col gap-3 animate-fade-in [--animate-delay:400ms] will-change-transform">
