  ...
  return (
    <div className="py-8 bg-white border-t">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-wrap justify-center items-center gap-6 animate-fadeIn">
          ...
          <img src="/lovable-uploads/klarna.svg" alt="Klarna" className="h-8 hover:opacity-80 transition-opacity" />
          <img src="/lovable-uploads/stripe.svg" alt="Stripe" className="h-8 hover:opacity-80 transition-opacity" />
