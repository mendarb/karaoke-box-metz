...
import { AnnouncementsSettings } from "@/components/admin/settings/AnnouncementsSettings";
        ...
        <ScrollArea className="w-full">
          <Tabs defaultValue="booking" className="space-y-4">
            <TabsList className="w-full justify-start overflow-x-auto">
              ...
              <TabsTrigger value="announcements" className="text-sm">Annonces</TabsTrigger>
